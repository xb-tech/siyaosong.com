...
const translations = {
  de: {
    ...
    "form.optionOne": "Konzertauftritt",
    "form.optionTwo": "Geigenunterricht",
    "form.optionThree": "Zusammenarbeit & anderes",
    "form.message": "Ihre Nachricht",
    "form.messagePlaceholder": "Datum, Anlass oder Anliegen",
  ...
  en: {
    ...
    "form.optionOne": "Performance invitation",
    "form.optionTwo": "Violin lessons",
    "form.optionThree": "Collaboration & other",
    "form.message": "Your message",
    "form.messagePlaceholder": "Date, occasion, or request",
  ...
  zh: {
    ...
    "form.contact": "您的邮箱",
    "form.contactPlaceholder": "您的邮箱",
    "form.intent": "我想要",
    "form.optionOne": "邀请演出",
    "form.optionTwo": "小提琴学习",
    "form.optionThree": "合作与其他",
    "form.message": "您的留言",
    "form.messagePlaceholder": "如日期、活动等",
    "form.submit": "发送这封信",
